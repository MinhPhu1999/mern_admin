...
class StatisticalContainer extends Component {
  ...
  getStatisticalByDay = async value => {
    ...
    try {
      res = await axios.post(
        "http://localhost:8080/order/statistical/revenue/day",
        {
          day: date[2],
          month: date[1],
          year: date[0]
  ...
  getStatisticalByMonth = async (value) => {
    ...
    try {
      res = await axios.post(
        "http://localhost:8080/order/statistical/revenue/month",
        {
          month: date[1],
          year: date[0]
        }
  ...
  getStatisticalByYear = async (year) => {
    ...
    try {
      res = await axios.post(
        "http://localhost:8080/order/statistical/revenue/year",
        {
          year: year
        }
      );
  ...
  getStatisticalByQuauter = async (year, quauter) => {
    ...
    try {
      res = await axios.post(
        "http://localhost:8080/order/statistical/revenue/quauter",
        {
          year: year,
          quauter: quauter
        }
